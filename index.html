...
<head>
    ...
    <meta name="google-translate-customization" content="5587c1b0a958bf07-62a8e309de686e87-gc92f61279a2c8524-11"/>
        ...
        <meta property="og:url" content="https://www.mediafire.com/file/efv6wrj75yk61g1/GoldHelpV2.txt/file"/>
        <meta property="og:title" content="GoldHelpV2"/>
        ...
        <meta name="twitter:url" content="https://www.mediafire.com/file/efv6wrj75yk61g1/GoldHelpV2.txt/file"/>
        <meta name="twitter:title" content="GoldHelpV2"/>
        ...
        <meta itemprop="name" content="GoldHelpV2"/>
    ...
    <script>
        try {
            ...
            gtag("js", new Date());
            gtag("config", "UA-829541-1", {"user_id":"3d859e8a01007bc6fbf01b8ac58c45dd","dimension1":"basic","dimension7":"legacy","dimension3":"document","dimension4":"71","dimension5":"txt","dimension8":"\/100\/"});
        } catch(e) {}
    </script>
    ...
    if ('1') amp.setUserId('');
    amp.setUserProperties({group: '2'});
    </script>            <script type="text/javascript">
        (function() {
            window.sib = {
                equeue: [],
                client_key: "zq92lixzx8sm89zud4yo6"
            };
            window.sendinblue = {};
        ...
        sendinblue.identify("thelordghaith@gmail.com", {
            "FIRSTNAME": "عاصم",
            "LASTNAME" : "محجوب",
            "COUNTRY": "YE",
            "PRODUCT_ID" : "66",
        ...
        </script>            <script src="https://btloader.com/tag?o=5678961798414336&upapi=true" async></script>    <!-- Google Tag Manager -->
...
<main role="main" class="mf-dlr page ads-alternate sticky-mode ads-enabled">
    ...
    <textarea id="copy" style="position:absolute;left:-9999px;opacity:0" aria-hidden="true" tabindex="-1">https://www.mediafire.com/file/efv6wrj75yk61g1/GoldHelpV2.txt/file</textarea>
    <div class="content">
        <style type="text/css">
    .header {
        position: absolute;
    ...
    .user-nav > .arrow {
        ...
        height: 12px;
        opacity: .5;
        background: url(//static.mediafire.com/images/icons/svg_dark/icons_sprite.svg) no-repeat -510px -5px!important;
    }
    ...
    #account.open > .user-nav,
    #account:target > .user-nav {
        background: #fff;
        color: #9e9d9d;
        padding-bottom: 2px;
...
<div class="header">
    ...
    <ul class="actions">
        <li class="d-hover">
            <a href="/" class="g-Btn g-Btn--secondary">
                <span class="g-Icon g-Icon--folder"></span>My Files
            </a>
        </li>
        <li id="account" class="dropdown d-hover">
            <a id="loggedin" class="user-nav" href="#" title="Logged in as thelordghaith@gmail.com">
                <span class="arrow"></span>
                                <span class="avatar">
                    <img src="https://www.mediafire.com/images/icons/myfiles/default.png" alt="User Avatar Icon"/>
                </span>
            </a>
            <ul id="loggedin_dropdown">
                <li class="ddStaticTxt">عاصم محجوب</li> 
<li class="ddStaticTxt"><div>thelordghaith@gmail.com</div></li>
...
<div class="center">
            <div id="ad_banner" class="ad_banner"></div>
<div class="lifetime-promo" style="display: none">
...
.header .logo a {
    background-image: url(//static.mediafire.com/images/backgrounds/header/mf_logo_full_color_reversed.svg);
    height: 30px;
...
body {
    ...
    background-image: radial-gradient(circle at 35% center, #1302AC 15%, #0E004A 65%, #0B0023 100%);
...
.MFDiscountOffer-heading span {
    display: inline-block;
    background-color: #006CFA;
    background-image: linear-gradient(to right, #3F00E0, #006CFA);
    border-radius: 12px;
    padding: 15px 20px 10px 20px;
    line-height: 1;
    box-shadow: 0 0 35px 0 rgba(26,62,239,.65);
    text-shadow: 0 4px rgba(0,0,0,.15);
}
.MFDiscountOffer-description {
    color: #fff;
    font-size: 22px;
    max-width: 800px;
    margin: 0 auto 20px;
}
.MFDiscountOffer-price {
    font-size: 56px;
    color: #fff;
    margin-bottom: 20px;
}
.MFDiscountOffer-price-compare {
    display: flex;
    justify-content: center;
...
.MFDiscountOffer-price-original {
    opacity: .7;
    color: #80B7FF;
    text-decoration: line-through;
}
.MFDiscountOffer-price-discount {
    font-weight: 900;
    color: #FFD762;
}
.MFDiscountOffer-price-per-month {
    font-size: 24px;
}
.MFDiscountOffer-price-three-years {
    font-size: 18px;
}
.MFDiscountOffer-price-three-years span {
    opacity: .7;
    color: #80B7FF;
    text-decoration: line-through;
}
.MFDiscountOffer-features ul {
    color: #fff;
    font-size: 18px;
    font-weight: 600;
    padding: 15px 0 45px;
...
.MFDiscountOffer-features li {
    display: flex;
    align-items: center;
    gap: 8px;
}
.MFDiscountOffer-features li span {
    height: 24px;
    width: 24px;
    background: url(//static.mediafire.com/images/download/upsell/gold_check_mark_circle.svg) center no-repeat;
...
.MFDiscountOffer-cta {
    ...
    font-size: 24px;
    font-weight: 700;
    box-shadow: 0 8px 32px -8px rgba(255,215,98,0.0), 0 16px 32px -16px rgba(255,215,98,0.0);
    box-sizing: border-box;
    transition: color 0.15s ease-in-out,background-color 0.15s ease-in-out, border-color 0.15s ease-in-out,box-shadow 0.15s ease-in-out;
}
.MFDiscountOffer-cta:not(:focus):hover {
    background-color: #FFD762;
    box-shadow: 0 8px 32px -8px rgba(255,215,98,0.72), 0 16px 32px -16px rgba(255,215,98,0.24);
    outline: none;
    color: #000;
}
.MFDiscountOffer-cta:not(:focus):before {
    content: "";
    position: absolute;
    height: 100%;
    width: 100%;
    ...
    background-color: #FFD762;
    box-shadow: 0 0 0 0 #FFD762;
}
.MFDiscountOffer-cta:hover:before {
    background-color: #FFD762;
    box-shadow: 0 0 0 4px #FFD762;
}
.MFDiscountOffer-continue-btn {
    display: inline-block;
    color: #fff;
    font-size: 20px;
    margin-top: 20px;
}
.MFDiscountOffer-continue-btn:hover {
    text-decoration: none;
}
...
@media (max-width: 550px) {
    ...
    <div class="MFDiscountOffer">
        <h2 class="MFDiscountOffer-heading">
            <span style="">60%</span> off MediaFire Pro
        </h2>
        <p class="MFDiscountOffer-description">
            We offer these services to you for free, please consider supporting MediaFire to keep it free for the community.
        </p>
        <div class="MFDiscountOffer-price">
            <div class="MFDiscountOffer-price-compare">
                <span class="MFDiscountOffer-price-original">$8.33</span>
                <span class="MFDiscountOffer-price-discount">$3.25</span>
                <span class="MFDiscountOffer-price-per-month">/mo</span>
            </div>
            <div class="MFDiscountOffer-price-three-years">
                ( <span>$99.99</span> $39 billed yearly )
            </div>
        </div>
        <div class="MFDiscountOffer-features">
            <ul>
                <li><span></span>Faster Downloads</li>
                <li><span></span>1TB of Storage</li>
                <li><span></span>50GB per File</li>
                <li><span></span>Bulk Download Files</li>
                <li><span></span>No Ads</li>
            </ul>
        </div>
        <a class="MFDiscountOffer-cta" href="/dynamic/af_link.php?a=45" target="_blank">Subscribe now</a>
        <!-- <a class="MFDiscountOffer-continue-btn" href="#">No thanks, continue to my download</a> -->
    </div>
</div>
...
<div class="dl-btn-cont">
            <div class="icon txt document text_plain"></div>
        <div class="dl-btn-labelWrap">
                            <div class="promoDownloadName notranslate">
                    <div class="dl-btn-label"
                        title="GoldHelpV2.txt">
                        GoldHelpV2                    </div>
                </div>
                                    <div class="dl-utility-nav">
                <ul>
                    <li>
                        <a href="https://www.mediafire.com/file/efv6wrj75yk61g1/GoldHelpV2.txt/file"
                            target="_blank"
                            rel="noopener"
                            id="shareButton"
     ...
     (function() {
         ...
         window.initDownload = function() {
            ...
            <div class="DLMobile-shareOptions">
                ...
                <li>
                    <a href="https://facebook.com/share.php?u=https://www.mediafire.com/file/efv6wrj75yk61g1/GoldHelpV2.txt/file"
    ...
    document.addEventListener("DOMContentLoaded", sticky.init.bind(sticky));
            ...
            >
                The download button will start your download and show a message from our advertisers in a new window.
                        ...
                        <div class="dl-info">
                <div class="intro icon txt document text_plain">
                    <div class="filename">GoldHelpV2.txt</div>
                    <div class="filetype"><span>Document</span><span> (.TXT)<span></span></span></div>
                </div>
                <ul class="details">
                    <li>File size: <span>4.12KB</span></li>
                    <li>Uploaded: <span>2024-12-12 18:32:47</span></li>
                </ul>
                ...
                <div class="sidebar">
                        ...
                        <ul>
                                                        <li>
                                <a class="nopop" href="https://www.mediafire.com/dynamic/af_link.php?a=16" target="_blank" rel="noreferrer" title="Microsoft 365">
                                    Microsoft 365                                </a>
                            </li>
                                                        <li>
                                <a class="nopop" href="https://www.mediafire.com/dynamic/af_link.php?a=17" target="_blank" rel="noreferrer" title="WordPerfect Office">
                                    WordPerfect Office                                </a>
                            </li>
                                                    </ul>
                    </div>
...
<div id="b9c-b87868" class="adsupply_ad_unit">
    <script src="//cdn.otnolatrnup.com/scripts/ba.js?z=87868"></script>
</div>                                            <style type="text/css">
    #b9c-b79507 {
        width: 336px; height: 280px; position: absolute; top: 110px; left: 0;
    }
</style>
<div id="b9c-b79507" class="adsupply_ad_unit">
    <script src="//cdn.otnolatrnup.com/scripts/ba.js?z=79507"></script>
</div>                                            <style type="text/css">
    #b9c-b87884 {
        width: 336px; height: 280px; position: absolute; top: 410px; left: 0;
    }
</style>
<div id="b9c-b87884" class="adsupply_ad_unit">
    <script src="//cdn.otnolatrnup.com/scripts/ba.js?z=87884"></script>
</div>                                            <style type="text/css">
    #b9c-b87883 {
        width: 728px; height: 90px; position: fixed; left: 50%; transform: translateX(-50%); bottom: 0; z-index: 99999
    }
</style>
<div id="b9c-b87883" class="adsupply_ad_unit">
    <script src="//cdn.otnolatrnup.com/scripts/ba.js?z=87883"></script>
</div>                                            <style type="text/css">
    #b9c-b87882 {
        width: 728px; height: 90px; position: absolute; top: 1268px; left: 50%; transform: translateX(-50%);
    }
</style>
<div id="b9c-b87882" class="adsupply_ad_unit">
    <script src="//cdn.otnolatrnup.com/scripts/ba.js?z=87882"></script>
</div>                                                </div>
    ...
    <div class="DLExtraInfo">
        ...
        <div class="DLExtraInfo-uploadLocation DLExtraInfo-column">
            ...
            <!-- <div class="DLExtraInfo-sectionHeading">This file&#8217;s upload location</div> -->
                        <div class="lazyload DLExtraInfo-sectionGraphic flag" data-lazyclass="flag-ye"></div>
                        <div class="DLExtraInfo-sectionDetails">
                <p>This file was uploaded from Yemen on December 12, 2024 at 6:32 PM</p>
            </div>
        </div>
    ...
    <div class="DLExtraInfo DLExtraInfo-additional">
                ...
                <div class="DLExtraInfo-accountStatus DLExtraInfo-column">
                    ...
                    <div class="DLExtraInfo-sectionDetails">
                        ...
                        <p>MediaFire user for: <b>1,683 days</b></p>
                    </div>
                </div>
    ...
    <div id="share" class="lightbox" role="dialog" tabindex="-1">
        <figure>
            ...
            <figcaption>
                <iframe
                    id="share-iframe"
                    data-src="https://www.mediafire.com/widgets/share.php?web=1&amp;dlr=1&amp;files=efv6wrj75yk61g1"
                    allowtransparency="true"
                    style="display:none">
                    <p id="share-desc">
        ...
        <div class="footerColWrap u-cf">
            ...
            <div class="footerCol">
                ...
                <ul>
                    ...
                    <li class="minFooterShow">
                        <a href="https://fast.io" title="Fast.io - File Sharing and Cloud Storage for Teams" target="_blank" rel="noopener noreferrer" aria-label="Fast.io - Team File Sharing and Cloud Storage for Small Businesses">Team File Sharing</a>
                    </li>
                </ul>
            </div>
    ...
    <div id="subFooterWrap">
        <div id="subFooter" class="u-wrap">
            <ul class="subFooterLinks">
                <li id="copyrightInfo">&copy;2024 MediaFire<span> Build 121931</span></li>
                ...
                window.addEventListener('load',  function() {
                    document.querySelectorAll('.popsok').forEach(function(element) {
                        element.addEventListener('click', function(event) {
                            ...
                            if (iAdCount < 3) {
                                iAdCount++;
                                document.cookie = "ad_count=" + iAdCount + ";expires=" + (new Date(1734051775000)).toGMTString() + ";path=/";
                            }
                        });
                    });
                });
...
(function() {
  // Options
  var optFileKey = "efv6wrj75yk61g1";
  var optFileName = "GoldHelpV2.txt";
  var optFileURL = "https://www.mediafire.com/file/efv6wrj75yk61g1/GoldHelpV2.txt/file";
  var optLoggedIn = "true" === "true";
  var optReportTurboDL = "false" === "true";
  var optSecurityToken = "1734049975.321622fc8f1b4a865d0e100105b0e262e634521fde8dab435bd146e05c70a92e";
...
(function() {
	// Detect ad blocker
	function showUpsell() {
		document.querySelector('div.lifetime-promo').style.display = 'flex';
		document.querySelector('div.lifetime-promo style').media = '';
	}
	...
	function detectAdBlocker() {
		const adElementIds = ['ad_banner'];
		const adElementClasses = ['ad_banner'];

		for (let i = 0; i < adElementIds.length; i++) {

			if ((element = document.getElementById(adElementIds[i])) !== null) {
		...
		for (let i = 0; i < adElementClasses.length; i++) {
			if ((element = document.getElementsByClassName(adElementClasses[i])[0]) !== undefined) {
				if (isElementHidden(element)) {
					showUpsell();
					return true;
				}
	...
	var adBlockerDetector = function() {
		if (detectAdBlocker() === false && timeout < 2500) {
			timeout = timeout * 5;
			setTimeout(adBlockerDetector, timeout);
		}
	}
	adBlockerDetector();
})();
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"8f11dc1b49a51894","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}},"version":"2024.10.5","token":"8e4f9484d8b840b28e4e0cc92b90ce0c"}' crossorigin="anonymous"></script>
</body>
</html>
